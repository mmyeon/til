...
- 원본 저장소에 있는 커밋 히스토리 받아오기
- 새로고침 기능으로 원본저장소의 이력을 업데이트함
...
- 변경 사항을 모두 남기면서 브랜치를 되돌리려면? soft/mixed reset
- 변경 사항을 모두 지우고 브랜치를 되돌리려면? soft/mixed reset
